							...
							<div className="list">
								<figure className="icon">
									<a href={"https://www.completeguidetoarchery.com/archery-for-beginners-how-to-get-started/"}>
										<img src={require("./images/CGtA.png")}/>
									</a>
								</figure>
							...
							<div className="list">
								<figure className="icon">
									<a href="https://www.archery360.com/where-to-shoot/">
										<img src={require("./images/A360.png")}/>
									</a>
								</figure>
							...
							<div className="list">
								<figure className="icon">
									<a href="https://performancearchery.net/">
										<img src={require("./images/PAlogo.png")}/>
									</a>
								</figure>
							...
							<div className="list">
								<figure className="icon">
									<a href="https://hoyt.com/">
										<img src={require("./images/HoytLogo.jpg")}/>
									</a>
								</figure>
							...
							<div className="list">
								<figure className="icon">
									<a href="https://archerytag.com/">
										<img src={require("./images/ATLogo.png")}/>
									</a>
								</figure>
